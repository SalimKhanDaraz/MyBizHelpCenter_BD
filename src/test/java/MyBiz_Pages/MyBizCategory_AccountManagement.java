...
public class MyBizCategory_AccountManagement extends MyBiz_Wait {

    MyBiz_CategoriesPageObjects myBiz_categoriesPageObjects = new MyBiz_CategoriesPageObjects(driver);

    public MyBizCategory_AccountManagement(WebDriver driver)
    {
    ...
    public void AccountManagement(WebDriver driver) throws InterruptedException {


        Thread.sleep(1000);
        WaitForElement().until(ExpectedConditions.visibilityOf(myBiz_categoriesPageObjects.MyBiz_AccountManagement)).click();
        Allure.step("Clicked on Account Management Category");
        ...
        for (int i = 0; i < size; i++) {
            ...
            Allure.step("Clicked on Account Management L2 Categories");
            ...
            try {
                ...
                for (int j = 0; j < Count; j++) {
                    ...
                    Allure.step("Clicked on Account Management Category Articles");
                    ...
                    if (Article) {
                        System.out.println("");
                        System.out.println("*****************************************************");
                        System.out.println("TC-8 PASSED: Account Management Article are available");
                        System.out.println("*****************************************************");
                    } else if (driver.findElement(By.className("MwbTmmbz_g0Hl47qPwDs")).isDisplayed()) {

                        System.out.println("");
                        System.out.println("************************************");
                        System.out.println("TC-8 FAILED: Error Page is Appearing");
                        System.out.println("************************************");
                        softAssert.assertFalse(true, "Error Page is Appearing");
                    } else {
                        System.out.println("");
                        System.out.println("************************************");
                        System.out.println("TC-8 FAILED: L2 Categories not found");
                        System.out.println("************************************");
            ...
            Allure.step("Clicked on Account Management Articles");
