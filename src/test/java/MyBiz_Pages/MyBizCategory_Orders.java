...
public class MyBizCategory_Orders extends MyBiz_Wait {

    MyBiz_CategoriesPageObjects myBiz_categoriesPageObjects = new MyBiz_CategoriesPageObjects(driver);

    public MyBizCategory_Orders(WebDriver driver) {PageFactory.initElements(driver, this);}
    ...
    public void Orders (WebDriver driver) throws InterruptedException {
        ...
        Thread.sleep(1000);
        WaitForElement().until(ExpectedConditions.visibilityOf(myBiz_categoriesPageObjects.MyBiz_Orders)).click();
        Allure.step("Clicked on Orders Category");
        ...
        for (int i = 0; i < size; i++) {
          ...
          //  System.out.println(i + " click: " + L2Categories.get(i).getText());
            ...
            Allure.step("Clicked on Orders L2 Categories");
                ...
                for (int j = 0; j < Count; j++) {
                   ...
                   // Allure.step("Clicked on Account Management Category Articles");
                    ...
                    if (Article) {
                        System.out.println("");
                        System.out.println("*****************************************");
                        System.out.println("TC-10 PASSED: L2 Categories are available");
                        System.out.println("*****************************************");
                    } else if (driver.findElement(By.className("MwbTmmbz_g0Hl47qPwDs")).isDisplayed()) {

                        System.out.println("");
                        System.out.println("*************************************");
                        System.out.println("TC-10 FAILED: Error Page is Appearing");
                        System.out.println("*************************************");
                        ...
                        System.out.println("");
                        System.out.println("***********************************************");
                        System.out.println("TC-10 FAILED: L2 Categories are appearing blank");
                        System.out.println("***********************************************");
            ...
            Allure.step("Clicked on Orders Category Articles");
