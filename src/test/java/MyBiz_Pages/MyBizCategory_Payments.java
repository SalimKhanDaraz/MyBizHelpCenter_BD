...
public class MyBizCategory_Payments extends MyBiz_Wait {
    MyBiz_CategoriesPageObjects myBiz_categoriesPageObjects = new MyBiz_CategoriesPageObjects(driver);

    public MyBizCategory_Payments(WebDriver driver)
    {
    ...
    public void Payments (WebDriver driver) throws InterruptedException {
        ...
        Thread.sleep(1000);
        WaitForElement().until(ExpectedConditions.visibilityOf(myBiz_categoriesPageObjects.MyBiz_Payments)).click();
        Allure.step("Clicked on Payments Category");
        ...
        for (int i = 0; i < size; i++) {
            ...
            try {
                ...
                for (int j = 0; j < Count; j++) {
                    ...
                    if (Article) {
                        System.out.println("");
                        System.out.println("****************************************");
                        System.out.println("TC-9 PASSED: L2 Categories are available");
                        System.out.println("****************************************");
                        ...
                        System.out.println("");
                        System.out.println("************************************");
                        System.out.println("TC-9 FAILED: Error Page is Appearing");
                        System.out.println("************************************");
                        ...
                        System.out.println("");
                        System.out.println("**********************************************");
                        System.out.println("TC-9 FAILED: L2 Categories are appearing blank");
                        System.out.println("**********************************************");
            ...
            Allure.step("Clicked on Payments Category Articles");
