...
public class MyBizCategory_Returns extends MyBiz_Wait {

    MyBiz_CategoriesPageObjects myBiz_categoriesPageObjects = new MyBiz_CategoriesPageObjects(driver);

    public MyBizCategory_Returns(WebDriver driver) {
        PageFactory.initElements(driver, this);}

    SoftAssert softAssert = new SoftAssert();


    public void Returns (WebDriver driver) throws InterruptedException {


        Thread.sleep(1000);
        WaitForElement().until(ExpectedConditions.visibilityOf(myBiz_categoriesPageObjects.MyBiz_Returns)).click();
        ...
        for (int i = 0; i < size; i++) {
            ...
            try {
                ...
                for (int j = 0; j < Count; j++) {
                    ...
                    if (Article) {
                        System.out.println("");
                        System.out.println("*****************************************");
                        System.out.println("TC-12 PASSED: L2 Categories are available");
                        System.out.println("*****************************************");
                    } else if (driver.findElement(By.className("MwbTmmbz_g0Hl47qPwDs")).isDisplayed()) {

                        System.out.println("");
                        System.out.println("*************************************");
                        System.out.println("TC-12 FAILED: Error Page is Appearing");
                        System.out.println("*************************************");
                        ...
                        System.out.println("");
                        System.out.println("**********************************************");
                        System.out.println("TC-12 FAILED: L2 Categories are appearing blank");
                        System.out.println("**********************************************");
            ...
            Allure.step("Clicked on Returns Category Articles");
